...
<AccordionGroup>
  ...
  <Accordion title="Requisitos Mínimos de RAM" icon="memory" iconType="solid">
    El mínimo de RAM para alojar un sitio o API es 512MB. Sin embargo, según tu aplicación Express, puede convenir más RAM para evitar el error [LACK_OF_RAM](https://docs.squarecloud.app/faqs/troubleshooting/LACK_OF_RAM).
  </Accordion>
