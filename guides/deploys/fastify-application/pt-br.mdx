...
<AccordionGroup>
  ...
  <Accordion title="RAM mínima" icon="memory" iconType="solid">
    O mínimo para hospedar um site ou API é 512 MB. Dependendo do tamanho do projeto, use mais RAM para evitar o erro [LACK_OF_RAM](https://docs.squarecloud.app/faqs/troubleshooting/LACK_OF_RAM).
  </Accordion>
