...
<AccordionGroup>
  ...
  <Accordion title="RAM mínima requerida" icon="memory" iconType="solid">
    La RAM mínima es 512 MB. Según el tamaño del proyecto Flask, podría necesitar más para evitar el error [LACK_OF_RAM](https://docs.squarecloud.app/faqs/troubleshooting/LACK_OF_RAM).
  </Accordion>
