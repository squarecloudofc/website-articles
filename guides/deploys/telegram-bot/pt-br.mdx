...
No arquivo de configuração da Square Cloud, o campo __START__ é opcional e só é necessário se você estiver usando um script personalizado para iniciar o bot. No exemplo fornecido, o campo __START__ não é necessário.
