...
<AccordionGroup>
  ...
  <Accordion title="Requisitos Mínimos de RAM" icon="memory" iconType="solid">
    A quantidade mínima de RAM necessária para hospedar um site ou API é 512MB, mas ao construir seu site diretamente na Square, é aconselhável usar uma quantidade maior, ou você poderá encontrar o erro [LACK_OF_RAM](https://docs.squarecloud.app/faqs/troubleshooting/LACK_OF_RAM).
  </Accordion>
