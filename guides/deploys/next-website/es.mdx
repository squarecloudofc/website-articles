...
<AccordionGroup>
  ...
  <Accordion title="Requisito Mínimo de RAM" icon="memory" iconType="solid">
    La cantidad mínima de RAM requerida para alojar un sitio es de 512 MB; sin embargo, al construir tu sitio directamente en Square, es aconsejable usar una cantidad mayor, o podrías encontrar el error [LACK_OF_RAM](https://docs.squarecloud.app/faqs/troubleshooting/LACK_OF_RAM).
  </Accordion>
